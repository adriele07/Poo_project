...
import { validarFormulario } from "../utils/FormsValidator";
...
const NewPlace = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const erros = validarFormulario({
      ...
      description,
      extras,
      photos: photoPreviews, // fotos que o usuário acabou de subir
      previewPhotos: existingPhotos, // fotos que já existiam no post
      checkin,
      checkout,
    });
