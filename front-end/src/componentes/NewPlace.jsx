    ...
    <form onSubmit={handleSubmit} className="flex w-full flex-col gap-6 px-8">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(225px,1fr))] gap-6">
          ...
          <div className="flex flex-col gap-2">
            <label className="ml-2 text-xl font-bold" htmlFor="checkin">Check-In</label>
              <input
                type="date"
                placeholder=""
                className="rounded-full border border-gray-300 text-gray-400 px-4 py-2"
                id="checkin"
                value={checkin}
          ...
          <div className="flex flex-col gap-2">
            <label className="ml-2 text-xl font-bold" htmlFor="person">Nº Convidados</label>
              <input
                type="number"
                min={0}
                placeholder="Pessoas"
      ...
      <button className="text-center bg-primary-button hover:bg-primary-button-500 min-w-44 cursor-pointer rounded-full px-4 py-2 text-white transition">Salvar nova acomodação</button>
    </form>
  );
};
