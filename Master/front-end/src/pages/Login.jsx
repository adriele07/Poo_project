...
const Login = ({ user, setUser }) => {
  ...
  return (
    ...
    <div className="flex w-full max-w-md flex-col items-center md:absolute gap-4 p-4 lg:w-1/2 lg:mx-auto md:left-1/14 md:justify-center md:items-center">
  ...
  <Spline
    className="flex invisible md:visible h-[300px] w-full items-center justify-center md:h-full md:w-1/2"
